    ...
    try:
        ...
        while True:
            ...
            if uid is not None:
                ...
                data_read_date = datetime.datetime.now().strftime('%Y-%m-%d')
                ...
                if read_date.write_to_tag(pn532, uid, data_read_date.encode()):
                ...
                read_date = read_date.read_from_tag(pn532, uid)
